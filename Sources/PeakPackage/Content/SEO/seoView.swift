...
struct seoView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: LocalNotificationManager.postNamefor(type: .loaded, subject: LocalNoteSubjects.SEORanks.rawValue)), perform: { _ in
            loaded = true
        })
    }
}
