...
public final class BarChartView2: UIView {
    ...
    public struct DataSet: Equatable {
        public struct DataElement: Equatable {
            ...
            public static func == (lhs: BarChartView2.DataSet.DataElement, rhs: BarChartView2.DataSet.DataElement) -> Bool {
            ...
            public init(date: Date?, xLabel: String, bars: [BarChartView2.DataSet.DataElement.Bar]) {
                self.date = date
                self.xLabel = xLabel
                self.bars = bars
            }
        ...
        public init(elements: [BarChartView2.DataSet.DataElement], limit: Limit? = nil, selectionColor: UIColor?) {
    ...
    public weak var delegate: BarChartView2Delegate?
    ...
    private func constructGraph(dataSet: DataSet) {
        ...
        dataSet.elements.forEach { element in
            ...
            elementViews.append(BarChartView2.ElementView(bars: barViews))
        }
...
fileprivate var mockBarChartDataSet: BarChartView2.DataSet? = BarChartView2.DataSet(elements: [
    BarChartView2.DataSet.DataElement(date: nil, xLabel: "Jan", bars: [BarChartView2.DataSet.DataElement.Bar(value: 20000, color: UIColor(red: 208/255, green: 207/255, blue: 209/255, alpha: 1.0)),
                                                              BarChartView2.DataSet.DataElement.Bar(value: 15000, color: UIColor(red: 208/255, green: 207/255, blue: 209/255, alpha: 1.0))]),
    BarChartView2.DataSet.DataElement(date: nil, xLabel: "Feb", bars: [BarChartView2.DataSet.DataElement.Bar(value: 0, color: UIColor(red: 208/255, green: 207/255, blue: 209/255, alpha: 1.0))]),
    BarChartView2.DataSet.DataElement(date: nil, xLabel: "Mar", bars: [BarChartView2.DataSet.DataElement.Bar(value: 10000, color: UIColor(red: 208/255, green: 207/255, blue: 209/255, alpha: 1.0)),
                                                              BarChartView2.DataSet.DataElement.Bar(value: 5000, color: UIColor(red: 208/255, green: 207/255, blue: 209/255, alpha: 1.0))]),
    BarChartView2.DataSet.DataElement(date: nil, xLabel: "Apr", bars: [BarChartView2.DataSet.DataElement.Bar(value: 20000, color: UIColor(red: 208/255, green: 207/255, blue: 209/255, alpha: 1.0)),
                                                              BarChartView2.DataSet.DataElement.Bar(value: 15000, color: UIColor(red: 208/255, green: 207/255, blue: 209/255, alpha: 1.0))]),
    BarChartView2.DataSet.DataElement(date: nil, xLabel: "May", bars: [BarChartView2.DataSet.DataElement.Bar(value: 32010, color: UIColor(red: 208/255, green: 207/255, blue: 209/255, alpha: 1.0)),
                                                              BarChartView2.DataSet.DataElement.Bar(value: 15000, color: UIColor(red: 208/255, green: 207/255, blue: 209/255, alpha: 1.0))]),
    BarChartView2.DataSet.DataElement(date: nil, xLabel: "Jun", bars: [BarChartView2.DataSet.DataElement.Bar(value: 20000, color: UIColor(red: 208/255, green: 207/255, blue: 209/255, alpha: 1.0))]),
    BarChartView2.DataSet.DataElement(date: nil, xLabel: "Jul", bars: [BarChartView2.DataSet.DataElement.Bar(value: 20000, color: UIColor(red: 208/255, green: 207/255, blue: 209/255, alpha: 1.0)),
                                                              BarChartView2.DataSet.DataElement.Bar(value: 0.5555, color: UIColor(red: 208/255, green: 207/255, blue: 209/255, alpha: 1.0))])
