...
extension Calendar{
    ...
    static func daysOfWeekInitials() -> [String]{
        let daysOfWeekInitials = ["S", "M", "T", "W", "T", "F", "S"]
        return daysOfWeekInitials
    }
...
private extension MonthView {
    ...
    var daysOfWeekHeader: some View {
        HStack(spacing: CalendarConstants.Monthly.gridSpacing) {
            ForEach(Calendar.daysOfWeekInitials(), id: \.self) { dayOfWeek in
                Text(dayOfWeek)
                    .font(.caption)
